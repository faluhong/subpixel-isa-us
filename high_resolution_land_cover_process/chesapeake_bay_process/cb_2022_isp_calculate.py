"""
    calculate the ISP for 2022 Chesapeake Bay Land Cover
"""
...
from high_resolution_land_cover_process.chesapeake_bay_process.cb_add_color_table import get_running_task_dataframe
        ...
        if non_data_pixel_count_row == ncol_1m * landsat_pixel_size:
            ...
            for col_id in range(0, ncol_1m, landsat_pixel_size):
                ...
                if non_data_pixel_count > 0:
                    ...
                    # Impervious surface, Other impervious surface, impervious surface roads
                    # Tree canopy over these types were calculated as impervious surface
                    # Barren is not calculated as impervious surface
