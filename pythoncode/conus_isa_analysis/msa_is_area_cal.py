"""
    calculate the impervious surface area change statistics for each MSA (metropolitan statistical area) from 1985 to 2022/2023
...
from pythoncode.conus_isa_analysis.utils_conus_isa_analysis import (extract_whole_region_mask, get_isp_change_stats)
from pythoncode.conus_isa_analysis.state_is_area_cal import (load_state_isp_stack)
...
# if __name__ =='__main__':
    ...
    path_msa_2015 = join(rootpath, 'data', 'CONUS_boundary', 'cb_2015_us_cbsa_500k')
