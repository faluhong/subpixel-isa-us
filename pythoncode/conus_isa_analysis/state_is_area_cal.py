"""
    calculate the impervious surface area change statistics for each state from 1985 to 2022
...
from pythoncode.util_function.tile_name_convert import (find_h_v_index_from_tile_name)
from pythoncode.post_processing.isp_ts_post_processing import load_conus_isp_stack
from pythoncode.conus_isa_analysis.utils_conus_isa_analysis import (load_conus_isp_stack, load_annual_nlcd_isp_stack,
                                                                    get_isp_change_stats,
                                                                    extract_whole_region_mask)
...
def main(rank, n_cores):
    ...
    for i in range(0, each_core_block):
        ...
        if new_rank > len(df_running_task) - 1:
            ...
            mask_whole_state = extract_whole_region_mask(df_conus_state_basic_info, i_state,
                                                         nrow=5000, ncol=5000, modify_target=modify_target)
