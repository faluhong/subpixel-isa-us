...
from pythoncode.conus_isa_analysis.utils_load_merge_conus_isp import load_merge_conus_is
...
# if __name__ =='__main__':
    ...
    steps = 3000    # latitude/longitude steps in pixels, each pixel is 30m, 1000 pixels = 30 km, 3000 pixels = 90 km
