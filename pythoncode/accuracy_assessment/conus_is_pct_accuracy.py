...
def plot_validation_scatterplot(x, y, x_label, y_label, cbar_label, title, errors_stats_plot,
                                figsize=(14, 10), xlim=(-2, 102), ylim=(-2, 102),
                                flag_1_to_1=True, flag_reg_line=True,
                                bins='log',
                                gridsize=50):
    """
        plot the scatterplot for validation
        Args:
            x: x values
            y: y values
            ...
            errors_stats_plot: the error statistics
            figsize: figure size
            xlim: x-axis limits
            ylim: y-axis limits
            flag_1_to_1: flag to plot the 1-to-1 line
            flag_reg_line: flag to plot the regression line
            bins: bins for the hexbin plot
    """
    ...
    if flag_1_to_1 == True:
        ...
        ax.plot([xlim[0], xlim[1]], [ylim[0], ylim[1]], color='#363737', linestyle='--', linewidth=3)

    if flag_reg_line == True:
        ...
        ax.plot(np.arange(0, 101), y_reg, color='black', linestyle='solid', linewidth=3)
