...
from pythoncode.high_resolution_land_cover_process.utils_high_resolution_land_cover_process import clip_high_resolution_land_cover_to_ard_tile
...
def save_with_compression(input_path, output_path, compression='LZW'):
    """
