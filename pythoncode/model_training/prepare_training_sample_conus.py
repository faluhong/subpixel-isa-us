"""
    ...
    The training data comes from three high-resolution land cover:
    (1) 2022 Chesapeake Bay
    (2) EnviroAtlas
    (3) Vermont
"""
...
if __name__ == '__main__':
    ...
    list_source = ['2022_Chesapeake_Bay', 'EnviroAtlas', 'vermont']  # '2022_Chesapeake_Bay', 'EnviroAtlas', 'vermont'
