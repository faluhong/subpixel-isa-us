...
# https://github.com/hamdaan19/UNet-Multiclass
...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(len(self.ups)):
            ...
            # If the height and width of output tensor and skip connection is not same, then resize the tensor
...
def test():
    image = torch.randn((32, 30, 161, 161))
    model = UNet(in_channels=30, num_classes = 8)
    out = model(image)
