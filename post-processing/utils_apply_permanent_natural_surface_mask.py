...
from evaluation.utils_evaluation import convert_6_tile_names_to_8_tile_names
...
def apply_permanent_natural_surface_us_land_boundary_mask(img_stack_ts_is_pct_post_processing,
    ...
    :param label_permanent_natural_surface: label for permanent natural surface, default is 0, for IS change types is 1
